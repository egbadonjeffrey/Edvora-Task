    ...
    <div className="--container">
      <div className={ride}>
        ...
        <div className={ride_d}>
          <p>
            Ride Id : <span className={val}>{id}</span>
          </p>

          <p>
            Origin Station : <span className={val}>{origin_station_code}</span>
          </p>

          <p>
            station_path :{" "}
            <span className={val}>{`[${station_path.join(", ")}]`}</span>
          </p>

          <p>
            Date: <span className={val}>{txtDate}</span>
          </p>

          <p>
            Distance: <span className={val}>{distance}</span>
          </p>
        </div>
